...
public class EmailSender {
    public static void sendActivationCode(String to,String activationCode) {

        // Recipient's email ID needs to be mentioned.
        to = "glovastas2004@gmail.com";

        // Sender's email ID needs to be mentioned
        String from = "glovastas2004@gmail.com";
        ...
        Session session = Session.getInstance(properties, new javax.mail.Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                ...
                return new PasswordAuthentication("glovastas2004@gmail.com", "dyhqlheeaastdurs");
